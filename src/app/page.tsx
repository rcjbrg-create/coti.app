  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] flex flex-col items-center justify-center p-6">
      ...
      <div className="mb-12 text-center">
        <div className="w-32 h-32 mx-auto mb-6 bg-gradient-to-br from-amber-500 to-amber-700 rounded-full flex items-center justify-center shadow-2xl">
          <span className="text-4xl font-bold text-white">C</span>
        </div>
        <h1 className="text-3xl font-bold text-amber-500 mb-2">COTI</h1>
        <p className="text-gray-400 text-sm">Restaurante & Bar</p>
      </div>
      ...
      {/* Acesso Admin */}
      <Link href="/admin">
        <div className="mt-8 flex items-center gap-2 text-gray-500 hover:text-amber-500 transition-colors cursor-pointer"
        >
          <Settings size={18} />
