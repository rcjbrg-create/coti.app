...
export default async function SalaoChecklistPage() {
    ...
    <div className="min-h-screen bg-[#1a1a1a] p-6">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-blue-500">Checklist - Salão</h1>
            ...
            items.length > 0 ? (
              <div key={freq}>
                ...
                <div className="space-y-2">
                  {items.map(checklist => (
                    <Link key={checklist.id} href={`/salao/checklist/${checklist.id}`}>
